...
#include "Tickable.h"
#include "SkyworthSceneCaptureCubemap.generated.h"
...
UCLASS()
class USkyworthSceneCaptureCubemap : public UObject, public FTickableGameObject
{
	GENERATED_BODY()
public:
	USkyworthSceneCaptureCubemap();
