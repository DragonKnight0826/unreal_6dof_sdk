...
#include "SkyworthFunctionLibrary.generated.h"
...
struct FSHmdUserProfileField
{
	...
	FSHmdUserProfileField() {}
	FSHmdUserProfileField(const FString& Name, const FString& Value) :
...
struct FSHmdUserProfile
{
	...
	UPROPERTY(BlueprintReadWrite, Category = "Input|HeadMountedDisplay")
	TArray<FSHmdUserProfileField> ExtraFields;
...
UCLASS()
class SKYWORTHHMD_API USkyworthFunctionLibrary : public UBlueprintFunctionLibrary
{
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="SkyworthLibrary")
	...
	*/
	UFUNCTION(BlueprintPure, Category = "SkyworthLibrary")
	static void GetRawSensorData(FVector& AngularAcceleration, FVector& LinearAcceleration, FVector& AngularVelocity, FVector& LinearVelocity, float& TimeInSeconds, FSTrackedDeviceType DeviceType = FSTrackedDeviceType::HMD);

	/**
	* Returns if the device is currently tracked by the runtime or not.
	*/
	UFUNCTION(BlueprintPure, Category = "SkyworthLibrary")
	static bool IsDeviceTracked(FSTrackedDeviceType DeviceType);

	/**
	* Returns if the device is currently tracked by the runtime or not.
	*/
	UFUNCTION(BlueprintCallable, Category = "SkyworthLibrary")
	...
	*/
	UFUNCTION(BlueprintPure, Category = "SkyworthLibrary")
	static bool GetUserProfile(FSHmdUserProfile& Profile);
	...
	*/
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "SkyworthLibrary", meta = (DeprecatedFunction, DeprecationMessage = "This feature is no longer supported."))
	 ...
	 * @param Options			(in) specifies either position, orientation or both should be set.
	 */
	UFUNCTION(BlueprintCallable, Category = "SkyworthLibrary", meta = (DeprecatedFunction, DeprecationMessage = "A hack, proper camera positioning should be used"))
	 ...
	 */
	UE_DEPRECATED(4.22, "USkyworthFunctionLibrary::ShowLoadingSplashScreen has been deprecated and no longer functions as before.  Use the generic UStereoLayerFunctionLibrary::ShowSplashScreen instead")
	UFUNCTION(BlueprintCallable, Category = "SkyworthLibrary", meta = (DeprecatedFunction, DeprecationMessage = "USkyworthFunctionLibrary::ShowLoadingSplashScreen has been deprecated and no longer functions as before.  Use the generic UStereoLayerFunctionLibrary::ShowSplashScreen instead"))
	 ...
	 */
	UE_DEPRECATED(4.22, "USkyworthFunctionLibrary::HideLoadingSplashScreen has been deprecated and no longer functions as before.  Use the generic UStereoLayerFunctionLibrary::HideSplashScreen instead")
	UFUNCTION(BlueprintCallable, Category = "SkyworthLibrary", meta = (DeprecatedFunction, DeprecationMessage = "USkyworthFunctionLibrary::HideLoadingSplashScreen has been deprecated and no longer functions as before.  Use the generic UStereoLayerFunctionLibrary::HideSplashScreen instead"))
	 ...
	 */
	UE_DEPRECATED(4.22, "USkyworthFunctionLibrary::EnableAutoLoadingSplashScreen has been deprecated and no longer functions as before.  Use the generic UStereoLayerFunctionLibrary::EnableAutoLoadingSplashScreen instead")
	UFUNCTION(BlueprintCallable, Category = "SkyworthLibrary", meta = (DeprecatedFunction, DeprecationMessage = "USkyworthFunctionLibrary::EnableAutoLoadingSplashScreen has been deprecated and no longer functions as before.  Use the generic UStereoLayerFunctionLibrary::EnableAutoLoadingSplashScreen instead"))
	 ...
	 */
	UE_DEPRECATED(4.22, "USkyworthFunctionLibrary::IsAutoLoadingSplashScreenEnabled has been deprecated and no longer functions as before. Please use the generic UStereoLayerFunctionLibrary instead.")
	UFUNCTION(BlueprintPure, Category = "SkyworthLibrary", meta = (DeprecatedFunction, DeprecationMessage = "USkyworthFunctionLibrary::IsAutoLoadingSplashScreenEnabled has been deprecated and no longer functions as before. Please use the generic UStereoLayerFunctionLibrary instead."))
	 ...
	 */
	UE_DEPRECATED(4.22, "USkyworthFunctionLibrary::ShowLoadingIcon has been deprecated and no longer functions as before. Please use the generic UStereoLayerFunctionLibrary instead.")
	UFUNCTION(BlueprintCallable, Category = "SkyworthLibrary", meta = (DeprecatedFunction, DeprecationMessage = "USkyworthFunctionLibrary::ShowLoadingIcon has been deprecated and no longer functions as before. Please use the generic UStereoLayerFunctionLibrary instead."))
	static void ShowLoadingIcon(class UTexture2D* Texture);

	/**
	 * Clears the loading icon. This call will clear all the splashes.
	 */
	UE_DEPRECATED(4.22, "USkyworthFunctionLibrary::HideLoadingIcon has been deprecated and no longer functions as before. Please use the generic UStereoLayerFunctionLibrary instead.")
	UFUNCTION(BlueprintCallable, Category = "SkyworthLibrary", meta = (DeprecatedFunction, DeprecationMessage = "USkyworthFunctionLibrary::HideLoadingIcon has been deprecated and no longer functions as before. Please use the generic UStereoLayerFunctionLibrary instead."))
	static void HideLoadingIcon();

	/**
	 * Returns true, if the splash screen is in loading icon mode.
	 */
	UE_DEPRECATED(4.22, "USkyworthFunctionLibrary::IsLoadingIconEnabled has been deprecated and no longer functions as before. Please use the generic UStereoLayerFunctionLibrary instead.")
	UFUNCTION(BlueprintPure, Category = "SkyworthLibrary", meta = (DeprecatedFunction, DeprecationMessage = "USkyworthFunctionLibrary::IsLoadingIconEnabled has been deprecated and no longer functions as before. Please use the generic UStereoLayerFunctionLibrary instead."))
	 ...
	 */
	UE_DEPRECATED(4.22, "USkyworthFunctionLibrary::SetLoadingSplashParams has been deprecated and no longer functions as before. Please use the generic UStereoLayerFunctionLibrary instead.")
	UFUNCTION(BlueprintCallable, Category = "SkyworthLibrary", meta = (DeprecatedFunction, DeprecationMessage = "USkyworthFunctionLibrary::SetLoadingSplashParams has been deprecated and no longer functions as before. Please use the generic UStereoLayerFunctionLibrary instead."))
	 ...
	 */
	UE_DEPRECATED(4.22, "USkyworthFunctionLibrary::GetLoadingSplashParams has been deprecated and no longer functions as before. Please use the generic UStereoLayerFunctionLibrary instead.")
	UFUNCTION(BlueprintPure, Category = "SkyworthLibrary", meta = (DeprecatedFunction, DeprecationMessage = "USkyworthFunctionLibrary::GetLoadingSplashParams has been deprecated and no longer functions as before. Please use the generic UStereoLayerFunctionLibrary instead."))
	...
	*/
	UFUNCTION(BlueprintPure, Category = "SkyworthLibrary")
	static FSFixedFoveatedRenderingLevel GetFixedFoveatedRenderingLevel();

	/**
	* Set the requested multiresolution level for the next frame
	*/
	UFUNCTION(BlueprintCallable, Category = "SkyworthLibrary")
	static void SetFixedFoveatedRenderingLevel(FSFixedFoveatedRenderingLevel level);
	...
	*/
	UFUNCTION(BlueprintPure, Category = "SkyworthLibrary|Guardian")
	...
	*/
	UFUNCTION(BlueprintPure, Category = "SkyworthLibrary|Guardian")
	static TArray<FVector> GetGuardianPoints(FSBoundaryType BoundaryType, bool UsePawnSpace = false);
	...
	*/
	UFUNCTION(BlueprintPure, Category = "SkyworthLibrary|Guardian")
	static FVector GetGuardianDimensions(FSBoundaryType BoundaryType);
	...
	* @param BoundaryType			(in) An enum representing the boundary type requested, either Outer Boundary (exact guardian bounds) or PlayArea (rectangle inside the Outer Boundary)
	*/
	UFUNCTION(BlueprintCallable, Category = "SkyworthLibrary|Guardian")
	static FSGuardianTestResult GetPointGuardianIntersection(const FVector Point, FSBoundaryType BoundaryType);
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "SkyworthLibrary|Guardian")
	static FSGuardianTestResult GetNodeGuardianIntersection(FSTrackedDeviceType DeviceType, FSBoundaryType BoundaryType);
	...
	*/
	...
	DECLARE_MULTICAST_DELEGATE_OneParam(FSkyworthGuardianTriggeredEvent, FSGuardianTestResult);

	/** When player returns within outer bounds */
	DECLARE_MULTICAST_DELEGATE(FSkyworthGuardianReturnedEvent);
	...
	*/
	//UPROPERTY(BlueprintAssignable, Category = "Input|SkyworthLibrary|Guardian")
	//static FSkyworthGuardianTriggeredEvent OnGuardianTriggered;
	...
	//UPROPERTY(BlueprintAssignable, Category = "SkyworthLibrary|Guardian")
	//FSkyworthGuardianReturnedEvent OnGuardianReturned;

protected:
	static class SkyworthHMD::FSkyworthHMD* GetOculusHMD();
};
