 ...
 */
UCLASS()
class SKYWORTHINPUT_API USkyworthVRControllerFunctionLibrary : public UBlueprintFunctionLibrary
{
...
public:
	 ...
	 */
	UFUNCTION(BlueprintPure, Category = "SkyworthVRController", meta = (Keywords = "SVR"))
	static ESkyworthVRControllerAPIStatus GetSkyworthVRControllerAPIStatus();

	/**
	 * Get the GoogleVR Controller state
	 */
	UFUNCTION(BlueprintPure, Category = "SkyworthVRController", meta = (Keywords = "SVR"))
	static ESkyworthVRControllerState GetSkyworthVRControllerState(EControllerHand Hand = EControllerHand::AnyHand);
	 ...
	 */
	UFUNCTION(BlueprintPure, Category = "SkyworthVRController", meta = (Keywords = "SVR"))
	static ESkyworthVRControllerHandedness GetSkyworthVRControllerHandedness();

	/**
	 * This function return the controller acceleration in gvr controller space.
	 */
	UFUNCTION(BlueprintPure, Category = "SkyworthVRController", meta = (Keywords = "SVR"))
	static FVector GetSkyworthVRControllerRawAccel(EControllerHand Hand = EControllerHand::AnyHand);
	 ...
	 */
	UFUNCTION(BlueprintPure, Category = "SkyworthVRController", meta = (Keywords = "SVR"))
	static FVector GetSkyworthVRControllerRawGyro(EControllerHand Hand = EControllerHand::AnyHand);

	/**
	 * This function return the orientation of the controller in unreal space.
	 */
	UFUNCTION(BlueprintPure, Category = "SkyworthVRController", meta = (Keywords = "SVR"))
	static FRotator GetSkyworthVRControllerOrientation(EControllerHand Hand = EControllerHand::AnyHand);

	/**
	 * Return a pointer to the UGoogleVRControllerEventManager to hook up GoogleVR Controller specific event.
	 */
	UFUNCTION(BlueprintCallable, Category = "SkyworthVRController", meta = (Keywords = "SVR"))
	...
	*/
	 ...
	 */
	UFUNCTION(BlueprintPure, Category = "SkyworthVRController", meta = (Keywords = "SVR"))
	static ESkyworthVRControllerBatteryLevel GetBatteryLevel(EControllerHand Hand = EControllerHand::AnyHand);
