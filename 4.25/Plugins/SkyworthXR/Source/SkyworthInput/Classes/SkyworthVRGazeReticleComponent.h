...
#include "SkyworthVRGazeReticleComponent.generated.h"
...
class SKYWORTHINPUT_API USkyworthVRGazeReticleComponent : public USceneComponent, public ISkyworthVRPointer
{
	GENERATED_BODY()

public:

	USkyworthVRGazeReticleComponent();
	...
	/** ISkyworthVRPointer Implementation */
...
public:
	void OnControllerConnectionStatues(bool connected);
};
