...
#include "SkyworthVRLaserVisual.h"
#include "SkyworthVRPointerInputComponent.h"
#include "Components/SceneComponent.h"
#include "SkyworthVRControllerFunctionLibrary.h"
#include "Engine/Texture2D.h"
#include "SkyworthVRMotionControllerComponent.generated.h"

class UMotionControllerComponent;
class ISkyworthVRLaserVisual;
...
class SKYWORTHINPUT_API USkyworthVRMotionControllerComponent : public USceneComponent, public ISkyworthVRPointer
{
	GENERATED_BODY()

public:

	USkyworthVRMotionControllerComponent();
	...
	*/
	...
	ESkyworthVRPointerInputMode PointerInputMode;

	/** If true, then a SkyworthVRInputComponent will automatically be created if one doesn't already exist. */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Input")
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "SkyworthVRMotionController", meta = (Keywords = "SVR"))
	...
	*/
	...
	virtual ESkyworthVRPointerInputMode GetPointerInputMode() const override;
...
private:
	...
	void OnControllerConnectionState(bool connected);

	APlayerController* PlayerController;
	USkyworthVRPointerInputComponent* InputComponent;

	UMotionControllerComponent* MotionControllerComponent;
	UStaticMeshComponent* ControllerMeshComponent;
	UStaticMeshComponent* ControllerTriggerMeshComponent;
	...
	USkyworthVRLaserVisual* LaserVisualComponent;

	FVector TouchMeshScale;
	bool bAreSubComponentsEnabled;
	ESkyworthVRControllerBatteryLevel LastKnownBatteryState;
