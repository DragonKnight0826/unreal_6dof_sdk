...
#include "SkyworthVRPointer.generated.h"
...
/**
 * ISkyworthVRPointer is an interface for pointer based input used with USkyworthVRPointerInputComponent.
 */
UINTERFACE(meta = (CannotImplementInterfaceInBlueprint))
class SKYWORTHINPUT_API USkyworthVRPointer : public UInterface
{
	GENERATED_UINTERFACE_BODY()
};

class SKYWORTHINPUT_API ISkyworthVRPointer
{
...
public:
	...
	/** Return the radius of the ray. It is used by SkyworthVRPointerInputComponent
	 ...
	 *  This is used by SkyworthVRPointerInputComponent to calculate the ray when using
	 *  the default "Camera" ESkyworthVRPointerInputMode. See SkyworthVRPointerInputComponent.h for details.
	 */
	 ...
	 *  If the pointer is inactive, then the USkyworthVRPointerInputComponent won't perform hit detection.
	 */
	virtual bool IsPointerActive() const = 0;

	/** Return the method used to detect what the pointer hits. */
	virtual ESkyworthVRPointerInputMode GetPointerInputMode() const = 0;
};
