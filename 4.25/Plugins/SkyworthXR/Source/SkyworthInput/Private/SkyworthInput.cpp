...
void FSkyworthInput::PreInit()
{
	...
	// Register the FKeys
	EKeys::AddKey(FKeyDetails(FSkyworthKey::SkyworthTouch_Left_Thumbstick, LOCTEXT("SkyworthTouch_Left_Thumbstick", "Skyworth Touch (L) Thumbstick CapTouch"), FKeyDetails::GamepadKey | FKeyDetails::FloatAxis | FKeyDetails::Deprecated));
	EKeys::AddKey(FKeyDetails(FSkyworthKey::SkyworthTouch_Left_FaceButton1, LOCTEXT("SkyworthTouch_Left_FaceButton1", "Skyworth Touch (L) X Button CapTouch"), FKeyDetails::GamepadKey | FKeyDetails::FloatAxis | FKeyDetails::Deprecated));
	EKeys::AddKey(FKeyDetails(FSkyworthKey::SkyworthTouch_Left_Trigger, LOCTEXT("SkyworthTouch_Left_Trigger", "Skyworth Touch (L) Trigger CapTouch"), FKeyDetails::GamepadKey | FKeyDetails::FloatAxis | FKeyDetails::Deprecated));
	EKeys::AddKey(FKeyDetails(FSkyworthKey::SkyworthTouch_Left_FaceButton2, LOCTEXT("SkyworthTouch_Left_FaceButton2", "Skyworth Touch (L) Y Button CapTouch"), FKeyDetails::GamepadKey | FKeyDetails::FloatAxis | FKeyDetails::Deprecated));
	EKeys::AddKey(FKeyDetails(FSkyworthKey::SkyworthTouch_Left_IndexPointing, LOCTEXT("SkyworthTouch_Left_IndexPointing", "Skyworth Touch (L) Pointing CapTouch"), FKeyDetails::GamepadKey | FKeyDetails::FloatAxis | FKeyDetails::NotBlueprintBindableKey, "SkyworthTouch"));
	EKeys::AddKey(FKeyDetails(FSkyworthKey::SkyworthTouch_Left_ThumbUp, LOCTEXT("SkyworthTouch_Left_ThumbUp", "Skyworth Touch (L) Thumb Up CapTouch"), FKeyDetails::GamepadKey | FKeyDetails::FloatAxis | FKeyDetails::NotBlueprintBindableKey, "SkyworthTouch"));

	EKeys::AddKey(FKeyDetails(FSkyworthKey::SkyworthTouch_Right_Thumbstick, LOCTEXT("SkyworthTouch_Right_Thumbstick", "Skyworth Touch (R) Thumbstick CapTouch"), FKeyDetails::GamepadKey | FKeyDetails::FloatAxis | FKeyDetails::NotBlueprintBindableKey));
	EKeys::AddKey(FKeyDetails(FSkyworthKey::SkyworthTouch_Right_FaceButton1, LOCTEXT("SkyworthTouch_Right_FaceButton1", "Skyworth Touch (R) A Button CapTouch"), FKeyDetails::GamepadKey | FKeyDetails::FloatAxis | FKeyDetails::NotBlueprintBindableKey));
	EKeys::AddKey(FKeyDetails(FSkyworthKey::SkyworthTouch_Right_Trigger, LOCTEXT("SkyworthTouch_Right_Trigger", "Skyworth Touch (R) Trigger CapTouch"), FKeyDetails::GamepadKey | FKeyDetails::FloatAxis | FKeyDetails::NotBlueprintBindableKey));
	EKeys::AddKey(FKeyDetails(FSkyworthKey::SkyworthTouch_Right_FaceButton2, LOCTEXT("SkyworthTouch_Right_FaceButton2", "Skyworth Touch (R) B Button CapTouch"), FKeyDetails::GamepadKey | FKeyDetails::FloatAxis | FKeyDetails::NotBlueprintBindableKey));
	EKeys::AddKey(FKeyDetails(FSkyworthKey::SkyworthTouch_Right_IndexPointing, LOCTEXT("SkyworthTouch_Right_IndexPointing", "Skyworth Touch (R) Pointing CapTouch"), FKeyDetails::GamepadKey | FKeyDetails::FloatAxis | FKeyDetails::NotBlueprintBindableKey, "SkyworthTouch"));
	EKeys::AddKey(FKeyDetails(FSkyworthKey::SkyworthTouch_Right_ThumbUp, LOCTEXT("SkyworthTouch_Right_ThumbUp", "Skyworth Touch (R) Thumb Up CapTouch"), FKeyDetails::GamepadKey | FKeyDetails::FloatAxis | FKeyDetails::NotBlueprintBindableKey, "SkyworthTouch"));
	...
	EKeys::AddKey(FKeyDetails(FSkyworthKey::SkyworthTouchpad_Touchpad_X, LOCTEXT("SkyworthTouchpad_Touchpad_X", "Skyworth Touchpad X-Axis"), FKeyDetails::GamepadKey | FKeyDetails::FloatAxis | FKeyDetails::Deprecated));
	EKeys::AddKey(FKeyDetails(FSkyworthKey::SkyworthTouchpad_Touchpad_Y, LOCTEXT("SkyworthTouchpad_Touchpad_Y", "Skyworth Touchpad Y-Axis"), FKeyDetails::GamepadKey | FKeyDetails::FloatAxis | FKeyDetails::Deprecated));
