...
#include "SkyworthVRLaserPlaneComponent.generated.h"

DEFINE_LOG_CATEGORY_STATIC(LogSkyworthVRLaserPlaneComponent, Log, All);
...
UCLASS(ClassGroup=(SkyworthInput))
class SKYWORTHINPUT_API USkyworthVRLaserPlaneComponent : public UStaticMeshComponent
{
	GENERATED_BODY()

public:

	USkyworthVRLaserPlaneComponent();
