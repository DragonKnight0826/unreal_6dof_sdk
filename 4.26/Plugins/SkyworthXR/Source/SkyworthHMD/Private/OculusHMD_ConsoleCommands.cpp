...
#include "OculusHMD.h"
#include "SkyworthSceneCaptureCubemap.h"
...
FConsoleCommands::FConsoleCommands(FSkyworthHMD * InHMDPtr)
	: UpdateOnRenderThreadCommand(TEXT("vr.oculus.bUpdateOnRenderThread"),
		*NSLOCTEXT("OculusRift", "CCommandText_UpdateRT",
		...
		FConsoleCommandWithWorldArgsAndOutputDeviceDelegate::CreateRaw(InHMDPtr, &FSkyworthHMD::UpdateOnRenderThreadCommandHandler))
	, PixelDensityMinCommand(TEXT("vr.oculus.PixelDensity.min"),
		*NSLOCTEXT("OculusRift", "CCommandText_PixelDensityMin",
		...
		FConsoleCommandWithWorldArgsAndOutputDeviceDelegate::CreateRaw(InHMDPtr, &FSkyworthHMD::PixelDensityMinCommandHandler))
	, PixelDensityMaxCommand(TEXT("vr.oculus.PixelDensity.max"),
		*NSLOCTEXT("OculusRift", "CCommandText_PixelDensityMax",
		...
		FConsoleCommandWithWorldArgsAndOutputDeviceDelegate::CreateRaw(InHMDPtr, &FSkyworthHMD::PixelDensityMaxCommandHandler))
	, HQBufferCommand(TEXT("vr.oculus.bHQBuffer"),
		*NSLOCTEXT("OculusRift", "CCommandText_HQBuffer",
		...
		FConsoleCommandWithWorldArgsAndOutputDeviceDelegate::CreateRaw(InHMDPtr, &FSkyworthHMD::HQBufferCommandHandler))
	, HQDistortionCommand(TEXT("vr.oculus.bHQDistortion"),
		*NSLOCTEXT("OculusRift", "CCommandText_HQDistortion",
		...
		FConsoleCommandWithWorldArgsAndOutputDeviceDelegate::CreateRaw(InHMDPtr, &FSkyworthHMD::HQDistortionCommandHandler))
	, ShowGlobalMenuCommand(TEXT("vr.oculus.ShowGlobalMenu"),
		*NSLOCTEXT("OculusRift", "CCommandText_GlobalMenu",
		...
		FConsoleCommandWithWorldArgsAndOutputDeviceDelegate::CreateRaw(InHMDPtr, &FSkyworthHMD::ShowGlobalMenuCommandHandler))
	, ShowQuitMenuCommand(TEXT("vr.oculus.ShowQuitMenu"),
		*NSLOCTEXT("OculusRift", "CCommandText_QuitMenu",
			"Oculus Rift specific extension.\nOpens the quit menu.").ToString(),
		FConsoleCommandWithWorldArgsAndOutputDeviceDelegate::CreateRaw(InHMDPtr, &FSkyworthHMD::ShowQuitMenuCommandHandler))
	...
	, StatsCommand(TEXT("vr.oculus.Debug.bShowStats"),
		*NSLOCTEXT("OculusRift", "CCommandText_Stats",
		...
		FConsoleCommandWithWorldArgsAndOutputDeviceDelegate::CreateRaw(InHMDPtr, &FSkyworthHMD::StatsCommandHandler))
	, CubemapCommand(TEXT("vr.oculus.Debug.CaptureCubemap"),
		*NSLOCTEXT("OculusRift", "CCommandText_Cubemap",
		...
		FConsoleCommandWithWorldArgsAndOutputDeviceDelegate::CreateStatic(&USkyworthSceneCaptureCubemap::CaptureCubemapCommandHandler))
	, ShowSettingsCommand(TEXT("vr.oculus.Debug.Show"),
		*NSLOCTEXT("OculusRift", "CCommandText_Show",
		...
		FConsoleCommandWithWorldArgsAndOutputDeviceDelegate::CreateRaw(InHMDPtr, &FSkyworthHMD::ShowSettingsCommandHandler))
	, IPDCommand(TEXT("vr.oculus.Debug.IPD"),
		*NSLOCTEXT("OculusRift", "CCommandText_IPD",
		...
		FConsoleCommandWithWorldArgsAndOutputDeviceDelegate::CreateRaw(InHMDPtr, &FSkyworthHMD::IPDCommandHandler))
