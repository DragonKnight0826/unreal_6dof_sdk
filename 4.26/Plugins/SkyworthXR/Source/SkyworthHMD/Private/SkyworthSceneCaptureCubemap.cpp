...
USkyworthSceneCaptureCubemap::USkyworthSceneCaptureCubemap()
	: Stage(None)
...
void USkyworthSceneCaptureCubemap::StartCapture(UWorld* World, uint32 InCaptureBoxSideRes, EPixelFormat InFormat)
{
...
void USkyworthSceneCaptureCubemap::Tick(float DeltaTime)
{
...
void USkyworthSceneCaptureCubemap::CaptureCubemapCommandHandler(const TArray<FString>& Args, UWorld* World, FOutputDevice& Ar)
{
	...
	USkyworthSceneCaptureCubemap*	CubemapCapturer = NewObject<USkyworthSceneCaptureCubemap>();
