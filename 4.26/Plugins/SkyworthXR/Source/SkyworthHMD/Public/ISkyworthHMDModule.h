 ...
 * within this plugin.
 */
class ISkyworthHMDModule : public IHeadMountedDisplayModule
{
public:
	 ...
	 */
	static inline ISkyworthHMDModule& Get()
	{
		return FModuleManager::LoadModuleChecked< ISkyworthHMDModule >("SkyworthHMD");
	}
	...
	{
		return FModuleManager::Get().IsModuleLoaded("SkyworthHMD");
	}
	...
	*/
	virtual bool GetUserProfile(struct FSHmdUserProfile& Profile)=0;
