...
#include "SkyworthVRLaserVisualComponent.generated.h"

UCLASS( ClassGroup=(SkyworthInput), meta=(BlueprintSpawnableComponent) )
class SKYWORTHINPUT_API USkyworthVRLaserVisualComponent : public USkyworthVRLaserVisual
{
	GENERATED_BODY()

public:
	// Sets default values for this component's properties
	USkyworthVRLaserVisualComponent();
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "SkyworthVRMotionController", meta = (Keywords = "SVR"))
	USkyworthVRLaserPlaneComponent* GetLaser() const;
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "SkyworthVRMotionController", meta = (Keywords = "Cardboard AVR GVR"))
...
private:
	...
	USkyworthVRLaserPlaneComponent* LaserPlaneComponent;
