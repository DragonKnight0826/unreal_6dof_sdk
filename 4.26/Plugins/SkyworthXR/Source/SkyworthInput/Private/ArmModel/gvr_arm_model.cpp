...
void Controller::ApplyArmModel(const UpdateData &update_data) {
  ...
  //UE_LOG(LogOcInput,Log,TEXT("controller_orientation (%f,%f,%f,%f)"), controller_orientation.x(), controller_orientation.y(), controller_orientation.z(), controller_orientation.w());
...
Vector3 Controller::ApplyInverseNeckModel(const UpdateData& update_data) {
  ...
  UE_LOG(LogOcInput, Log, TEXT("XXXX ApplyInverseNeckModel headRotation:(%f,%f,%f,%f)"), headRotation.x(), headRotation.y(), headRotation.z(), headRotation.w());
