//=============================================================================
// FILE: SnapdragonVRHMD_CustomPresent_Vulkan.cpp
//
...
class FVulkanCustomPresentSVR : public FSnapdragonVRHMDCustomPresent//, public FVulkanCustomPresent
{
public:
	FVulkanCustomPresentSVR(FSnapdragonVRHMD* pHMD)
...
private:
	class FSnapdragonVRTextureSet_Vulkan* mTextureSet;
};
...
extern void TextureSetProxy_SetupRenderLayer(const FSnapdragonVRTextureSet_Vulkan* TextureSetProxy, GSXRRenderLayer* RenderLayer, const uint32* pFd);
extern void TextureSetProxy_SwitchToNextElement(FSnapdragonVRTextureSet_Vulkan* TextureSetProxy);
...
extern VkSemaphore TextureSetProxy_GetSignalSemaphore(const FSnapdragonVRTextureSet_Vulkan* TextureSetProxy);
...
// }
// 
// extern VkImage TextureSetProxy_GetBackBufferImage(const FSnapdragonVRTextureSet_Vulkan* TextureSetProxy);
// 
...
// }
// 
// extern VkImageView TextureSetProxy_GetBackBufferImageView(const FSnapdragonVRTextureSet_Vulkan* TextureSetProxy);
// 
