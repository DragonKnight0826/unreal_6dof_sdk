...
#define SNAPDRAGONVR_HMD_SUPPORTED_PLATFORMS_OPENGLES	PLATFORM_ANDROID
#define SNAPDRAGONVR_HMD_SUPPORTED_PLATFORMS_VULKAN		0
#else 
#define SNAPDRAGONVR_HMD_SUPPORTED_PLATFORMS_OPENGLES	0
#define SNAPDRAGONVR_HMD_SUPPORTED_PLATFORMS_VULKAN		0
 ...
 * within this plugin.
 */
class ISnapdragonVRHMDModule : public IHeadMountedDisplayModule
{

public:

	static const FName SnapdragonVRHMDModuleName;
	/**
	 ...
	 */
	static inline ISnapdragonVRHMDModule& Get()
	{
		return FModuleManager::LoadModuleChecked< ISnapdragonVRHMDModule >(SnapdragonVRHMDModuleName);
	}
	...
	{
		return FModuleManager::Get().IsModuleLoaded(SnapdragonVRHMDModuleName);
	}
};
